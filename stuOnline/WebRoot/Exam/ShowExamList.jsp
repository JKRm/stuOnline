...
<html>
	...
	<body>
	  ...
	  <h3>开始答题</h3>
		...
		%>	
					<li><a href="exam/showAction.action?e_id=<%=exam1List.get(i).getE_id() %>">题目<%=i+1 %></a></li>
		<%		}%>
				</ul>
		<%	}%>
		...
		%>	
					<li><a href="exam/showAction.action?e_id=<%=exam2List.get(i).getE_id() %>">题目<%=i+1%></a></li>
		<%		}%>
				</ul>
		<%	}%>
		...
		%>	
					<li><a href="exam/showAction.action?e_id=<%=exam3List.get(i).getE_id() %>">题目<%=i+1 %></a></li>
		<%		}%>
				</ul>
		<%	}%>
		...
		%>	
					<li><a href="exam/showAction.action?e_id=<%=exam4List.get(i).getE_id() %>">题目<%=i+1 %></a></li>
		<%		}%>
				</ul>
		<%	}%>
		...
		%>	
					<li><a href="exam/showAction.action?e_id=<%=exam5List.get(i).getE_id() %>">题目<%=i+1 %></a></li>
		<%		}%>
				</ul>
		<%	}%>
		...
		%>	
					<li><a href="exam/showAction.action?e_id=<%=exam6List.get(i).getE_id() %>">题目<%=i+1 %></a></li>
		<%		}%>
				</ul>
		<%	}%>
		...
		%>	
					<li><a href="exam/showAction.action?e_id=<%=exam7List.get(i).getE_id() %>">题目<%=i+1 %></a></li>
		<%		}%>
				</ul>
		<%	}%>
		...
		%>	
					<li><a href="exam/showAction.action?e_id=<%=exam8List.get(i).getE_id() %>">题目<%=i+1 %></a></li>
		<%		}%>
				</ul>
		<%	}%>
	  </div>
