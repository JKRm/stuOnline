...
<html>
  <head>
	...
	function add(obj) {
		...
		var father = document.getElementById("unit").value;
		if(obj.value=="添加…"){
        ...
        $.post(
           		...
           		{'content':content,'father':father,'introduction':'小节'},
           		function (data, statusCode) {
           			if (statusCode == 404 || statusCode == 400 || statusCode == 500) {
           				alert("未知错误");
           			}
      ...
      function update(cid,content){
		...
		$.post(
           		...
           		{'cid':cid,'content':content,'father':father,'introduction':'小节'},
           		function (data, statusCode) {
           			if (statusCode == 404 || statusCode == 400 || statusCode == 500) {
           				alert("未知错误");
           			}
