...
<html>
  <head>
	...
	function add(obj) {
		...
		var father = document.getElementById("lesson").value;
		if(obj.value=="添加…"){
        ...
        $.post(
           		...
           		{'content':content,'father':father,'introduction':'单元'},
           		function (data, statusCode) {
           			if (statusCode == 404 || statusCode == 400 || statusCode == 500) {
           				alert("未知错误");
           			}
      ...
      function update(cid,content){
		...
		$.post(
           		...
           		{'cid':cid,'content':content,'father':father,'introduction':'单元'},
           		function (data, statusCode) {
           			if (statusCode == 404 || statusCode == 400 || statusCode == 500) {
           				alert("未知错误");
           			}
