...
<div style="position:relative;left:350px;top:50px;width:275px;height:175px;border-style:solid;border-width:1pt;border-color:#cacaca;background-color:#fafafa;">

  <img src="<%=basePath %>home/images/exit.png">
</div>
